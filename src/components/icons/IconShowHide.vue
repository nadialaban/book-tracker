...
<template>
    <svg v-if="!hide" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#000000" stroke-width="1"
         stroke-linecap="round" stroke-linejoin="miter">
        <path d="M9.14,9a4,4,0,0,0,5.65,5.65Z" fill="#EEE7DA" stroke-width="0"/>
    ...
    <svg v-else viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#000000" stroke-width="1"
         stroke-linecap="round" stroke-linejoin="miter">
        <path d="M2,12S5,4,12,4s10,8,10,8-2,8-10,8S2,12,2,12Z"/>
        <circle cx="12" cy="12" r="4" stroke-width="0" fill="#EEE7DA"/>
